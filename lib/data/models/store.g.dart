...
extension StoreQueryFilter on QueryBuilder<Store, Store, QFilterCondition> {
  ...
  QueryBuilder<Store, Store, QAfterFilterCondition> isActiveEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isActive',
...
extension StoreQuerySortBy on QueryBuilder<Store, Store, QSortBy> {
  ...
  QueryBuilder<Store, Store, QAfterSortBy> sortByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }

  QueryBuilder<Store, Store, QAfterSortBy> sortByIsActiveDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StoreQuerySortThenBy on QueryBuilder<Store, Store, QSortThenBy> {
  ...
  QueryBuilder<Store, Store, QAfterSortBy> thenByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }

  QueryBuilder<Store, Store, QAfterSortBy> thenByIsActiveDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.desc);
    });
  }
...
extension StoreQueryWhereDistinct on QueryBuilder<Store, Store, QDistinct> {
  ...
  QueryBuilder<Store, Store, QDistinct> distinctByIsActive() {
    return QueryBuilder.apply(this, (query) {
...
extension StoreQueryProperty on QueryBuilder<Store, Store, QQueryProperty> {
  ...
  QueryBuilder<Store, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
