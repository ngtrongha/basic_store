...
void _orderSerialize(
  ...
  writer.writeDouble(offsets[0], object.change);
  ...
  writer.writeLong(offsets[4], object.pointsDelta);
...
Order _orderDeserialize(
  ...
  final object = Order();
  object.change = reader.readDouble(offsets[0]);
  ...
  object.items = reader.readObjectList<OrderItem>(
      ...
      [];
  object.pointsDelta = reader.readLong(offsets[4]);
...
extension OrderQueryFilter on QueryBuilder<Order, Order, QFilterCondition> {
  QueryBuilder<Order, Order, QAfterFilterCondition> changeEqualTo(
    double value, {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> changeGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> changeLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> changeBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> pointsDeltaEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'pointsDelta',
        value: value,
      ));
    });
  }

  QueryBuilder<Order, Order, QAfterFilterCondition> pointsDeltaGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> pointsDeltaLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> pointsDeltaBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension OrderQuerySortBy on QueryBuilder<Order, Order, QSortBy> {
  QueryBuilder<Order, Order, QAfterSortBy> sortByChange() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'change', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> sortByChangeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterSortBy> sortByPointsDelta() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsDelta', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> sortByPointsDeltaDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsDelta', Sort.desc);
    });
  }
...
extension OrderQuerySortThenBy on QueryBuilder<Order, Order, QSortThenBy> {
  QueryBuilder<Order, Order, QAfterSortBy> thenByChange() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'change', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> thenByChangeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'change', Sort.desc);
    });
  }
  ...
  QueryBuilder<Order, Order, QAfterSortBy> thenByPointsDelta() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsDelta', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> thenByPointsDeltaDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsDelta', Sort.desc);
    });
  }
...
extension OrderQueryWhereDistinct on QueryBuilder<Order, Order, QDistinct> {
  QueryBuilder<Order, Order, QDistinct> distinctByChange() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QDistinct> distinctByPointsDelta() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'pointsDelta');
    });
  }
...
extension OrderQueryProperty on QueryBuilder<Order, Order, QQueryProperty> {
  ...
  QueryBuilder<Order, double, QQueryOperations> changeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, int, QQueryOperations> pointsDeltaProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'pointsDelta');
    });
  }
