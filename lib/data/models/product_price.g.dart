...
ProductPrice _productPriceDeserialize(
  ...
  object.storeId = reader.readLong(offsets[3]);
...
extension ProductPriceQuerySortBy
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByStoreId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storeId', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByStoreIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storeId', Sort.desc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByValidFrom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validFrom', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByValidFromDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validFrom', Sort.desc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByValidTo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validTo', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByValidToDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductPriceQuerySortThenBy
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByStoreId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storeId', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByStoreIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storeId', Sort.desc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByValidFrom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validFrom', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByValidFromDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validFrom', Sort.desc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByValidTo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validTo', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByValidToDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'validTo', Sort.desc);
    });
  }
...
extension ProductPriceQueryWhereDistinct
  ...
  QueryBuilder<ProductPrice, ProductPrice, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QDistinct> distinctByStoreId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'storeId');
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QDistinct> distinctByValidFrom() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'validFrom');
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QDistinct> distinctByValidTo() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductPriceQueryProperty
  ...
  QueryBuilder<ProductPrice, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, int, QQueryOperations> storeIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'storeId');
    });
  }

  QueryBuilder<ProductPrice, DateTime?, QQueryOperations> validFromProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'validFrom');
    });
  }

  QueryBuilder<ProductPrice, DateTime?, QQueryOperations> validToProperty() {
    return QueryBuilder.apply(this, (query) {
