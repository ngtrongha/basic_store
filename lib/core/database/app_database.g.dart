...
class $CategoriesTable extends Categories
  ...
  late final GeneratedColumn<String> color = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('#27AE60'),
  );
...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  late final GeneratedColumn<String> unit = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('cái'),
  );
...
class DebtPayment extends DataClass implements Insertable<DebtPayment> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, debtId, amount, paymentMethod, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$CustomersTableTableManager
    extends
        RootTableManager<
          ...
          Customer,
          PrefetchHooks Function({bool ordersRefs, bool debtsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({ordersRefs = false, debtsRefs = false}) {
            return PrefetchHooks(
              db: db,
...
final class $$OrdersTableReferences
  ...
  static MultiTypedResultKey<$DebtsTable, List<Debt>> _debtsRefsTable(
    ...
    db.debts,
    aliasName: $_aliasNameGenerator(db.orders.id, db.debts.orderId),
  );
                ...
                return PrefetchHooks(
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      ...
                      if (debtsRefs)
                        await $_getPrefetchedData<Order, $OrdersTable, Debt>(
                          currentTable: table,
                          referencedTable: $$OrdersTableReferences
                              ._debtsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$OrdersTableReferences(db, table, p0).debtsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.orderId == item.id,
                              ),
...
final class $$DebtsTableReferences
  ...
  static $OrdersTable _orderIdTable(_$AppDatabase db) => db.orders.createAlias(
    $_aliasNameGenerator(db.debts.orderId, db.orders.id),
  );
